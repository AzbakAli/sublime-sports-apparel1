...
export default function ChenillePatches() {
  const designs = Array.from({ length: 32 }, (_, i) => ({
    index: i,
    imageSrc: `/images/Chenile (${i + 1}).jfif`
  }));
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h1 className="font-heading text-5xl md:text-6xl font-extrabold text-primary mb-4">
              <span className="text-gradient-gold">Chenille</span> Patches
            </h1>
            <p className="text-primary/70 text-lg max-w-2xl mx-auto">
              Classic chenille letterman patches with fuzzy texture and vintage appeal
            </p>
          </motion.div>
