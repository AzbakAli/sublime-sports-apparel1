...
export default function EmbroideredPatches() {
  const designs = [
    ...
    { index: 30, imageSrc: "/images/newembroideredpatches (1).jfif" },
    { index: 31, imageSrc: "/images/newembroideredpatches (2).jfif" },
    { index: 32, imageSrc: "/images/newembroideredpatches (3).jfif" },
    { index: 33, imageSrc: "/images/newembroideredpatches (4).jfif" },
    { index: 34, imageSrc: "/images/newembroideredpatches (5).jfif" },
    { index: 35, imageSrc: "/images/newembroideredpatches (6).jfif" },
    { index: 36, imageSrc: "/images/newembroideredpatches (7).jfif" },
    { index: 37, imageSrc: "/images/newembroideredpatches (8).jfif" },
    { index: 38, imageSrc: "/images/newembroideredpatches (9).jfif" },
    { index: 39, imageSrc: "/images/newembroideredpatches (10).jfif" },
    { index: 40, imageSrc: "/images/newembroideredpatches (11).jfif" },
    { index: 41, imageSrc: "/images/newembroideredpatches (12).jfif" },
    { index: 42, imageSrc: "/images/newembroideredpatches (13).jfif" },
    { index: 43, imageSrc: "/images/newembroideredpatches (14).jfif" },
    { index: 44, imageSrc: "/images/newembroideredpatches (15).jfif" },
    { index: 45, imageSrc: "/images/newembroideredpatches (16).jfif" },
    { index: 46, imageSrc: "/images/newembroideredpatches (17).jfif" },
    { index: 47, imageSrc: "/images/newembroideredpatches (18).jfif" },
    { index: 48, imageSrc: "/images/newembroideredpatches (19).jfif" },
    { index: 49, imageSrc: "/images/newembroideredpatches (20).jfif" },
  ];
